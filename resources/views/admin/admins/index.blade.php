...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold fs-3 mb-1">Admins</span>
            <span class="text-muted mt-1 fw-semibold fs-7">Over {{ $admins->count() }} admins</span>
        </h3>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                ...
                <tbody>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex justify-content-start flex-column">
                                    <p class="text-dark fw-bold fs-6">{{$admin->name}}</p>
                                </div>
                            </div>
                        </td>
                        <td>
                            <p class="text-dark fw-bold d-block fs-6">{{$admin->email}}</p>
                        </td>
                        <td>
                    ...
                    @else
                    <h3 class="card-title align-items-start flex-column">
                        <span class="text-muted mt-1 fw-semibold fs-7">No admins</span>
                    </h3>
                    @endif
