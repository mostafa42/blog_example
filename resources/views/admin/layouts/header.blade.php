        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <img src="{{$lang=='en'?  asset('custom_images/england.jpeg') : asset('custom_images/egypt.jpeg') }}" style="width:30px; margin-right:10px;">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <a href="{{url('language/ar')}}"><img src="{{asset('custom_images/egypt.jpeg')}}" style="width:30px; margin:0px 15px;">عربي</a>
                                </div>
                                <div class="symbol symbol-50px me-5">
                                <a href="{{url('language/en')}}"><img src="{{asset('custom_images/england.jpeg')}}" style="width:30px; margin:0px 15px;">English</a>
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
